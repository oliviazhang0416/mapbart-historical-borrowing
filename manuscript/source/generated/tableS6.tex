...
\noindent Sc1 and Sc2 at $n_{\mathrm{trt}}=200$ include all five lrcBART priors and all three comparator settings.
\begingroup
...
\multicolumn{7}{l}{\strut\textit{Mean difference: $n_{\mathrm{trt}}=200$, Sc1}}\\*
...
\multicolumn{7}{l}{\strut\textit{Mean difference: $n_{\mathrm{trt}}=200$, Sc2}}\\*
