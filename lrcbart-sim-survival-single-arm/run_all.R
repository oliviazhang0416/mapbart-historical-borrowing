...
script_dir <- file.path(mainDir, "lrcbart-sim-survival-single-arm")
...
# ---- Simulation design ----
# LRC-BART ADDITION START
# Both approved survival single-arm sample sizes run through the same pipeline.
# LRC-BART ADDITION END
p_obs <- 10L
...
serial_files <- c("AFTv2.R", "hierAFT.R", "lrcBART.R")
