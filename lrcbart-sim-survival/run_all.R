...
#   3. Run analyses     via  AFTv1, AFTv2, AFTv3, hierAFT, BARTv1, BARTv2, BARTv3, lrcBART
...
mainDir <- .lrcRoot
script_dir <- file.path(mainDir, "lrcbart-sim-survival")
...
# ---- Analysis files ----
# LRC-BART MODIFICATION START
files <- c("AFTv1.R", "AFTv2.R", "AFTv3.R", "BARTv1.R", "BARTv2.R",
           "BARTv3.R", "hierAFT.R", "lrcBART.R")
# LRC-BART MODIFICATION END
...
# The Stan and LRC-BART methods therefore run serially; only the three
...
#
# LRC-BART MODIFICATION START
# lrcBART.R owns its target loop and local ESS calls.
