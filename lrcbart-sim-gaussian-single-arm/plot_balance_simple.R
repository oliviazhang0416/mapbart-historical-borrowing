...
# The inherited simple balance plots are retained for Sc1 and Sc2 in the
# single-arm design.
mainDir <- .lrcRoot
data_folder <- "data"
...
save_pipeline_plot(paste0(file.path(mainDir),"/lrcbart-sim-gaussian-single-arm/inserts/balanced_1.jpg"),
       width = 16,
...
save_pipeline_plot(paste0(file.path(mainDir),"/lrcbart-sim-gaussian-single-arm/inserts/balanced_2.jpg"),
       width = 24,
       height = plot_height,
       p_balance,
       limitsize = FALSE)
